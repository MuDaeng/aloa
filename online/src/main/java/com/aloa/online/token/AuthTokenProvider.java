...
import com.aloa.online.configuration.security.oauth.OAuth2UserInfo;
...
public class AuthTokenProvider {
    ...
    private String generateToken(Authentication authentication, long expireTime, String secretKey) {
        ...
        var principal = (PrincipalDetails) authentication.getPrincipal();

        var name = principal.getName();
        var subject = principal.getUsername();
